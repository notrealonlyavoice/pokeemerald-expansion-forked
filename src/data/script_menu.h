...
static const struct MenuAction MultichoiceList_R1ANSWERS[] =
{
    {gText_R1A1},
    {gText_R1A2},
    {gText_R1A3},
...
static const struct MenuAction MultichoiceList_R3ANSWERS[] =
{
    {gText_R3A1},
    {gText_R3A2},
    {gText_R3A3},
...
static const struct MenuAction MultichoiceList_RFANSWERS[] =
{
    {gText_RFA1},
    {gText_RFA2},
    {gText_RFA3},
...
static const struct MultichoiceListStruct sMultichoiceLists[] =
{
    ...
    [MULTI_RIDDLE_THREE]               = MULTICHOICE(MultichoiceList_R3ANSWERS),
    [MULTI_RIDDLE_FINAL]               = MULTICHOICE(MultichoiceList_RFANSWERS),
};
