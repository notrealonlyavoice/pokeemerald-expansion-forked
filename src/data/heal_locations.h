static const struct HealLocation sHealLocations[] =
{
    ...
    [HEAL_LOCATION_ISLANDNEW - 1] = {MAP_GROUP(ISLANDNEW), MAP_NUM(ISLANDNEW), 10, 20},
    [HEAL_LOCATION_ONECAVE - 1] = {MAP_GROUP(ONECAVE), MAP_NUM(ONECAVE), 20, 38},
    [HEAL_LOCATION_NEW_MAP6 - 1] = {MAP_GROUP(NEW_MAP6), MAP_NUM(NEW_MAP6), 5, 7},
    [HEAL_LOCATION_ICECAVES2 - 1] = {MAP_GROUP(ICECAVES2), MAP_NUM(ICECAVES2), 12, 22},
    [HEAL_LOCATION_SHIPPP - 1] = {MAP_GROUP(SHIPPP), MAP_NUM(SHIPPP), 25, 4},
    [HEAL_LOCATION_TRICKHOUSE_FINALE - 1] = {MAP_GROUP(TRICKHOUSE_FINALE), MAP_NUM(TRICKHOUSE_FINALE), 19, 39},
};
