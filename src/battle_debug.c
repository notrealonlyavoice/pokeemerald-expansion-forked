...
static const u8 sText_HoldEffectCrackedLens[] = _("Cracked Lens");
...
static const u8 sText_HoldEffectPowerCharm[] = _("Power Charm");
...
static const u8 *const sHoldEffectNames[] =
{
    ...
    [HOLD_EFFECT_CRACKED_LENS] = sText_HoldEffectCrackedLens,
    ...
    [HOLD_EFFECT_POWER_CHARM] = sText_HoldEffectPowerCharm,
